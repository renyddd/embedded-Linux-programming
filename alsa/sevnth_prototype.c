...
int exec_aplay(char *pname)
{
    printf("Before aplay, show pname: %s", pname);
    printf("\n");
...
int main()
{
    ...
    while(1) {
        ...
        if ( x <= 300 && y <= 300 )
        {
            printf("close just_record_name: %s\n", main_name);
            bmp_show("/mnt/m.bmp");
            free(main_name);
            break;
        }
        ...
        /*
         * arecord field (shell command) * x >= 722 * y <= 300
         */
        else if ( x >= 722 && y <= 300)
        {
        ...
        else if ( x > 722 && y > 300 )
        {
            ...
            bmp_show("/mnt/UI2.0.bmp");
            aplay_num = exec_aplay(main_name);
        }
    }
